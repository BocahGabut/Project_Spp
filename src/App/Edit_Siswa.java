...
public class Edit_Siswa extends javax.swing.JDialog {
    ...
    private void Update()
    {
        ...
        try
        {
            ...
            java.sql.Statement stat = (java.sql.Statement) db_connection.getKoneksi().createStatement();
            String sql = "Update siswa set nama = '"+nama.getText()+"',kelas = '"+kelas.getText()+"',"
                    + "jurusan = '"+jurusan.getSelectedItem()+"', tmp_lahir = '"+tmp.getText()+"',"
                    + "tgl_lahir = '"+tgl+"', jk = '"+jk+"',agama = '"+agama.getSelectedItem()+"',"
                    + "no_hp = '"+no_hp.getText()+"',alamat = '"+alamat.getText()+"'"
                    + " where nis = '"+nis.getText()+"' ";
            java.sql.PreparedStatement p = (java.sql.PreparedStatement) db_connection.getKoneksi().prepareStatement(sql);
            p.executeUpdate();
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/icons8_Edit_25px_1.png"))); // NOI18N
    ...
    public static javax.swing.JComboBox<String> agama;
    ...
    public static javax.swing.JComboBox<String> jurusan;
    public static javax.swing.JTextField kelas;
    ...
    public static javax.swing.JTextField no_hp;
    public static javax.swing.JRadioButton perem;
    public static com.toedter.calendar.JDateChooser tgl_lahir;
    public static javax.swing.JTextField tmp;
