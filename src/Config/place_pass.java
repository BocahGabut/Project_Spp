 ...
 * @author Randkill
 */
public class place_pass extends JPasswordField{
    ...
    public place_pass(String text){
        initListener();
    }
  
    public place_pass(int columns){
        initListener();
    }
  
    public place_pass(String text, int columns){
        super(text, columns);
        initListener();
    }
  
    public place_pass(Document doc, String text, int columns){
